...
\author{%
  Nolan ~Capomaggio\\
  Mathis ~Morra-Fisher\thanks{Erasmus Students} \\
  Warsaw University Of technologies\\
  \texttt{https://github.com/orion6002/EARIN_lab_group_19} \\
...
\begin{abstract}
  ...
  In this work, we address binary sentiment classification of Amazon product 
  reviews, distinguishing positive (4–5 stars) from negative (1–2 stars) 
  opinions. We use the Amazon Reviews dataset (Kaggle, bittlingmayer), 
  comprising approximately 4 million labeled reviews. We propose to compare 
